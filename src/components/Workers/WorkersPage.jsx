                ...
                <div>
                    ...
                    <Container fluid style={{ marginTop: 20 }} className="d-flex justify-content-center">
                        <Col style={{ marginLeft: '2%', margin: '2%', width: '90%' }}>
                            <Tabs variant="pills" defaultActiveKey="man" id="uncontrolled-tab-example">
                                <Tab eventKey="man" title="Менеджеры">
                                ...
                                <Tab eventKey="work" title="Разработчики">
                                        <div className="box_xs">
                                            {
                                                Orgs.map(item => (
                                ...
                                <Tab eventKey="group" title="Рабочие группы">
                                        <div className="box_xs">
                                            {
                                                Orgs.map(item => (
    ...
    render() {
        ...
        return (
            ...
            >
                <Col>
                    <Row style={{ marginTop: 7, marginBottom: 7 }}>
                        <Col><img style={{borderRadius : '50%'}} width="75" height="75" src={this.props.data.user_image_src} /></Col>
                        <Col className="d-flex align-items-center justify-content-end">
                            <div>
