            ...
            <Container style={styles.containerStyle}>
                                            ...
                                            <Row>
                                                <Col sm={3}>
                                                    <Nav
                                                        ...
                                                        <Nav.Item>
                                                            <Nav.Link
                                                                eventKey="first">Иcпользуемые технологии</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link
                                                                eventKey="api">Методы RESTapi</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link
                                                                eventKey="godep">Зависимости GoLang</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link
                                                                eventKey="reactdep">Зависимости React.js</Nav.Link>
                                                        </Nav.Item>
                                                    </Nav>
                                                </Col>
                                                <Col sm={9}>
                                                    <Tab.Content>
                                                        <Tab.Pane eventKey="first">
                                                            <ul>
                                                                <li>
                                                                    React - технология описание веб-интерфейса (фронтэнд) -
                                                                    <a href="http://reactjs.org">http://reactjs.org</a>
                                                                </li>
                                                                <li>
                                                                    GoLang - основной язык приложения (бэкенд) -
                                                        ...
                                                        <Tab.Pane eventKey="api">
                                                            <p>Все реализованные RestAPI запросы описаны в модуле
                                                                <code>routes.go</code>
                                                            </p>
                                                            <ul>
                                                                <li>GET
                ...
                <div
                    ...
                    <Jumbotron className="bg-white">
                        ...
                        <ul>
                            ...
                            <li>Ветка релиза :
                                <a href="https://github.com/Naiks10/goreactapp/tree/master">master</a>
                            </li>
                            <li>Ветка с отладкой и подробным тестированием :
                                <a href="https://github.com/Naiks10/goreactapp/tree/debug">debug</a>
                            </li>
                        </ul>
                        <Accordion>
                            <Card>
                                            ...
                                            <Row>
                                                <Col sm={3}>
                                                    ...
                                                    className="flex-column">
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="master">Чем отличается master от debug?</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="build">Что требуется, чтобы собрать проект?</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="time">Сколько уходит времени на компиляцию go-кода?</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="gobuild">Делаю go-build страница не меняется :(</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="and">Как одномерменнно запустить сборку golang и react?</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="tests">Тесты... Какие тесты вы испоьзуете для отладки?</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="crypt">В вашем продукте есть шифрование? Как отдельный модуль?</Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item>
                                                            <Nav.Link 
                                                            eventKey="db">Вижу в проекте всё, кроме базы - Где она?</Nav.Link>
                                                        </Nav.Item>
                                                    </Nav>
                                                </Col>
                                                <Col sm={9}>
                                                    <Tab.Content>
                                                        <Tab.Pane eventKey="master">
                                                            ...
                                                            <ul>
                                                                <li>Ветка 
                                                                    <code>master</code> 
                                                                    включает в себя уже отработанную версию продукта, которая прошла все тесты по новым функциям и модулям
                                                                </li>
                                                                <li>Ветка 
                                                                    <code>debug</code> 
                                                                    соответственно включает в себя все тесты, возможно баги, которые заметны невооруженным взглядом, возможно отключены какие-нибудь модули
                                                                </li>
                                                            </ul>
                                                        </Tab.Pane>
                                                        ...
                                                        <Tab.Pane eventKey="gobuild">
                                                            <p>Плохо читаете предыдущие пункты :) Для сборки интерфейса требуется 
                                                                <code>npm run build</code>
                                                            </p>
                                                        </Tab.Pane>
                                                        <Tab.Pane eventKey="and">
                                                            ...
                                                            <ul>
                                                                <li>Запустите две команды через два амперсанда : 
                                                                    <code>go build &amp;&amp; npm run build</code>
                                                                </li>
                                                                <li>Однако не рекомендуем так делать, можно спутать ошибки</li>
                                                            </ul>
                                                        </Tab.Pane>
                                                        <Tab.Pane eventKey="tests">
                                                            <p>Мы используем встроенный пакет по тестированию 
                                                                <code>testing</code>
                                                            </p>
                                                            <p>Все тесты в нашем продукте делятся на юнит-тесты и интеграционные.</p>
                                                            <p>Их можно найти в ветке 
                                                                <b>debug</b> 
                                                                - все файлы с постфиксом 
                                                                <code>_test</code>
                                                            </p>
                                                        </Tab.Pane>
                ...
                <div className="bg-white" style={styles.containerStyle._mainPageStyle}>
                    <Jumbotron className="bg-white">
                        ...
                        <ul>
                            <li>Версия после первичной отладки, в которой есть недочёты - 
                                <b>Sirin</b>
                            </li>
                            <li>Версия "кандидат в релиз" - 
                                <b>Ghamamyun</b>
                            </li>
                            <br />
                            <li>Скачайте архив с приложением 
                                <a href="https://github.com/Naiks10/goreactapp/releases">
                                    "просто открой *.exe"
                                </a>
                            </li>
                        </ul>
