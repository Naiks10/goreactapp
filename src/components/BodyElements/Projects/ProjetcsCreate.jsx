        ...
        return (
            <React.Fragment>
                <div className="ProjectElement" style={styles.divStyle}>
                    <Form>
                        ...
                        <Form.Group>
                            ...
                            <Form.Text 
                                className="text-muted">
                                Если у вас очень много интересной информации, 
                                и в несколько строчек не уместитесь, то это наверно ТЗ. 
                                Не копируйте весь текст. 
                                Давайте перейдём к след. пункту
                            </Form.Text>
                        </Form.Group>
                        <Form.Group>
                            <Form.Label>
                                Всё не поместилось в панель информации? 
                                Пришлите нам файлы  с ТЗ. БЗ, ФЗ, ПЗ 
                                (честно, мы не знаем, существует ли что-то за исключением ТЗ, но всё же)
                            </Form.Label>
                            <Form.Row><ProjectDocsElement /></Form.Row>
                            <Form.Text 
                                className="text-muted">
                                    Не кидайте более 20 файлов, наш сис.админ будет ругаться. 
                                    Можете предоставить ссылку на файлообменник в предыдщем пункте.
                            </Form.Text>
                        </Form.Group>
                        <Form.Group>
                ...
                <div style={{ marginLeft: 40, marginRight: 40 }}>
                    ...
                    <Form.Text 
                        className="text-muted">
                            Эта кнопочка создаст заявку на создание проекта
                    </Form.Text>
                </div>
            </React.Fragment>
        );
